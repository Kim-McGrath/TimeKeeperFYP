...
/**
 * Database entity representing a practice session.
 * Stores session metadata and aggregate statistics.
 */
...
data class Session(
    ...
    /**
     * Calculates the accuracy rate as a value between 0 and 1
     */
    val accuracyRate: Double
        get() = accuracyPercentage / 100.0

    /**
     * Gets a human-readable description of timing tendency
     */
