...
interface HitDao {
    ...
    /**
     * Inserts a new hit into the database.
     * @return The ID of the newly inserted hit
     */
    ...
    /**
     * Gets all hits for a specific session as Flow (reactive).
     */
    @Query("SELECT * FROM hits WHERE sessionId = :sessionId ORDER BY hitTimestamp ASC")
    ...
    /**
     * Deletes all hits (useful for testing or data reset).
     */
